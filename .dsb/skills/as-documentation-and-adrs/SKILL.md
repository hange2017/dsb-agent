---
name: as-documentation-and-adrs
...
<!--
  ...
  Inspired by addyosmani/agent-skills skill "documentation-and-adrs" (MIT).
...
- **DSB.md / rules files** — Document project conventions so agents follow them
...
- [ ] Rules files (DSB.md etc.) are current and accurate
