...
4. After installation, reload the window (Reload Window), open **DSBAgent** from the Command Palette, and configure a provider and API Key (see "Quick Start" below).
