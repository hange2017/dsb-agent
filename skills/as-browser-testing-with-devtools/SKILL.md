---
name: as-browser-testing-with-devtools
...
<!--
  ...
  Inspired by addyosmani/agent-skills skill "browser-testing-with-devtools" (MIT).
...
Add the following to your project's `.mcp.json` or DSBAgent settings:
